export const articleTexts = [
  {
    ...
    artImg: "art01",
    artPerex: "Porodní plán shrnuje představy, přání a požadavky rodičů na okolnosti narození jejich miminka a zdravotní služby, které jim budou při porodu poskytovány. Každý rodičovský pár považuje za důležité něco jiného, proto mohou mít porodní plány a porodní přání různý obsah i různou formu.",
    artBody: "",
  },
  {
    artTitle: "Co by mělo osobní porodní přání obsahovat?",
    artImg: "art02",
    artPerex: "„Porodní přání“, nebo také „porodní plán“ je nástroj, který můžete použít ke komunikaci s ošetřujícím personálem během přípravy na porod, při porodu a v šestinedělí. Umožní vám přehledně formulovat, jaká jsou Vaše přání a hodnoty a shrne základní informace, které by měla porodní asistentka, lékař, nebo další poskytovatelé zdravotní péče o Vás vědět.",
    artBody: "",
  },
]